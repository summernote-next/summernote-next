...
describe('summernote-next-classic option guards', () => {
  it('covers the missing options.modules branch', async() => {
    ...
    await import( `/src/styles/classic/summernote-next-classic.js?guards-modules=${Date.now()}`);
  ...
  it('covers the missing options branch', async() => {
    ...
    await import( `/src/styles/classic/summernote-next-classic.js?guards-options=${Date.now()}`);
