const deDE = {
  ...
  color: {
    ...
    cpSelect: 'Auswählen',
    colorsName: [
      ['Schwarz', 'Dunkelgrau', 'Taubengrau', 'Sternenstaub', 'Blassschiefer', 'Galerie', 'Alabaster', 'Weiß'],
      ['Rot', 'Orangenschale', 'Gelb', 'Grün', 'Cyan', 'Blau', 'Elektrisches Violett', 'Magenta'],
      ['Azalee', 'Apricot', 'Eierschale', 'Zartgrün', 'Botticelli', 'Tropenblau', 'Mischka', 'Dämmerung'],
      ['Rosa', 'Pfirsichorange', 'Creme Brulee', 'Spross', 'Casper', 'Perano', 'Kühles Lila', 'Rosagrau'],
      ['Korallrot', 'Rajah', 'Löwenzahn', 'Olivgrün', 'Golfstrom', 'Wikingerblau', 'Blaue Margerite', 'Puce'],
      ['Wachrot', 'Feuerbusch', 'Goldtraum', 'Chelsea-Gurke', 'Schmachtblau', 'Boston-Blau', 'Schmetterlingsbusch', 'Cadillac'],
      ['Sangria', 'Mai Tai', 'Buddha-Gold', 'Waldgrün', 'Eden', 'Venedig-Blau', 'Meteorit', 'Bordeaux'],
      ['Rosenholz', 'Zimt', 'Olive', 'Petersilie', 'Tiber', 'Mitternachtsblau', 'Valentino', 'Loulou'],
    ],
  },
  shortcut: {
